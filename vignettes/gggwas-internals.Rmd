...
## old version
ggplot(data = GWAS.utils::giant) + stat_gwas_qq_hex(aes(observed = P), hex.function = ggplot2:::hexBinSummarise) 

## new version
#ggplot(data = GWAS.utils::giant) + stat_gwas_qq_hex(aes(y = P))

## same as
ggplot(data = GWAS.utils::giant) + stat_gwas_qq_hex(aes(observed = P), hex.function = ggGWAS:::hexBinSummarise) 
