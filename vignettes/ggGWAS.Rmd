...
data_whr <- data.table::fread("https://portals.broadinstitute.org/collaboration/giant/images/6/6e/Whradjbmi.giant-ukbb.meta-analysis.combined.23May2018.HapMap2_only.txt.gz")
data_whr[1:3,]
```
...
```{r qqplot-example-filter, fig.height=6, fig.width=6, out.width="40%", echo = FALSE, warning = FALSE, cache = TRUE}
ggplot(data = data_whr) + 
...
```{r qqplot-example-hex-zoom, fig.height=5, fig.width=10, out.width="80%", echo = FALSE, cache = TRUE}
...
```{r qqplot-example-group, fig.width=11, fig.height = 4, out.width="80%", echo = FALSE, cache = TRUE}
...
```{r qqplot-example-scale, fig.height=6, fig.width=6, out.width="40%", echo = FALSE, cache = TRUE}
ggplot(data = data_whr) + 
