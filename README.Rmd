...
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/sinarueeger/ggGWAS?branch=master&svg=true)](https://ci.appveyor.com/project/sinarueeger/ggGWAS)
